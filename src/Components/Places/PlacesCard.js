...
const PlacesCard = (props) => {
    ...
    const routeChange = () => {
        nevigate('/PlacesDetails', { state: { name: props.name, image: props.image, map:props.map } })
    }
    return (
        <div className='hotelCard'>
            ...
            <div className='d-flex flex-column p-4'>
                ...
                <p className="smallpara">Places Description Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime iusto, cumque blanditiis fugiat neque dolorem ad</p>
